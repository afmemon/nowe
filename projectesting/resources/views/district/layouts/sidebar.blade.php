					...
					<ul class="submenu">
						<li class="">
							@if($value['roles'][0]['user_type_id'] == 1)
								<a href="/district/changeRoleInUsManager/{{$value['roles'][0]['user_type_id']}}" >
							@else
								<a href="" class="dropdown-toggle">
							@endif
								<i class="menu-icon fa fa-caret-right"></i>
							...
							<b class="arrow"></b>
								@forelse($value['roles'] as $key1 => $value1)
									<ul class="submenu">
										<li class="">
											<a href="/district/changeRole/{{$value1['country_id']}}/{{$value1['partner_organization_id']}}/{{$value1['user_type_id']}}">
												<i class="menu-icon fa fa-caret-right"></i>
												{{$value1['cont_name']}}
											</a>
											<b class="arrow"></b>
